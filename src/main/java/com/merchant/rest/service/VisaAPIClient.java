...
public class VisaAPIClient {
    ...
    NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException {
    	URL url = VisaAPIClient.class.getResource("/VD.jks");
        SSLContext sslcontext = SSLContexts.custom()
                        .loadKeyMaterial(new File(url.getPath()),
	...
	public void doGooglePostNotification(String path, String body, MethodTypes method) throws Exception {
		String url = "https://fcm.googleapis.com/fcm/send";
		HttpClient client = HttpClientBuilder.create().build();
		HttpPost post = new HttpPost(url);
		post.setHeader("Content-Type", "application/json");
		post.setHeader("Authorization", "key=AIzaSyD3SAMf2_1C9zcZbL1NfpIUdqHA8fedG9M");
    ...
    public String doMutualAuthRequest(String path, String testInfo, String body, MethodTypes methodType, Map<String, String> headers) 
                    throws Exception {
    ...
    public String doXPayTokenRequest(String baseUri, String resourcePath, String queryParams, String testInfo, String body, MethodTypes methodType, Map<String, String> headers)
                    throws Exception {
    ...
    private static String logAndReturnResponse(CloseableHttpResponse response) throws IOException {
